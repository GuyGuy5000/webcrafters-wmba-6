...
namespace wmbaApp.Controllers
{
    ...
    public class TeamsController : ElephantController
    {
           ...
           .FirstOrDefaultAsync(m => m.ID == id);
            ...
            switch (userRole)
            {
                case "RookieC":
                    ...
                    break;
                case "IntermediateC":
                    if (team.Division.DivName != "11U" && team.Division.DivName != "13U")
                    {
                        if (!findingCoach)
                        {
                            return Forbid();
                    ...
                    break;
                case "Convenor":
                    if (team.Division.DivName != "15U" && team.Division.DivName != "18U")
                    {
                        if (!findingCoach)
                        {
                            return Forbid();
        ...
        public async Task<IActionResult> Edit(int id, int? coachID)
        {
            ...
            {
                case "RookieC":
                    if (teamToUpdate.Division.DivName != "9U")
                    {
                        if (!findingCoach)
                        {
                            return Forbid();
                    ...
                    break;
                case "IntermediateC":
                    if (teamToUpdate.Division.DivName != "11U" && teamToUpdate.Division.DivName != "13U")
                    {
                        if (!findingCoach)
                        {
                            return Forbid();
                    ...
                    break;
                case "Convenor":
                    if (teamToUpdate.Division.DivName != "15U" && teamToUpdate.Division.DivName != "18U")
                    {
                        if (!findingCoach)
                        {
                            return Forbid();
